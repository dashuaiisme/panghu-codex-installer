...
class CommercialFlowAcceptanceTests(unittest.TestCase):
    def test_offline_acceptance_script_covers_order_payment_entitlement_sessions_and_reversal(self) -> None:
        ...
        self.assertEqual(report["commissions"]["created_count"], 8)
        ...
        self.assertEqual(report["communication_software_link"]["callback_delivery_status"], "delivered")
        self.assertEqual(report["communication_software_link"]["callback_delivery_replay_status"], "replayed")
        self.assertEqual(report["communication_software_link"]["callback_delivery_commission_count"], 1)
        self.assertEqual(report["communication_software_link"]["callback_delivery_commission_cents"], 1990)
        self.assertEqual(report["communication_software_link"]["callback_replay_status"], "already_delivered")
        ...
        self.assertEqual(report["communication_software_link"]["final_order_status_scope"], "offline_mock")
