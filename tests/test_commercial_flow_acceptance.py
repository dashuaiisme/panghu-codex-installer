...
class CommercialFlowAcceptanceTests(unittest.TestCase):
    def test_offline_acceptance_script_covers_order_payment_entitlement_sessions_and_reversal(self) -> None:
        ...
        self.assertTrue(report["mobile_control"]["unpaid_session_blocked"])
        self.assertEqual(report["mobile_control"]["paid_charge_status"], "paid")
        self.assertEqual(report["mobile_control"]["connected_session_status"], "connected")
        self.assertEqual(report["mobile_control"]["callback_status"], "accepted")
        self.assertEqual(report["mobile_control"]["final_order_status"], "delivered")
        self.assertEqual(report["mobile_control"]["final_charge_status"], "paid")
        self.assertEqual(report["mobile_control"]["service_ledger_service_type"], "mobile_control_agent")
        self.assertEqual(report["mobile_control"]["service_ledger_event_type"], "mobile_control_agent_delivered")
